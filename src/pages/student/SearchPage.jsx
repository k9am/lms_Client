...
const SearchPage = () => {
  ...
  const [searchKey, setSearchKey] = useState(0) // Add a key to force re-fetch

  // Use the key to force re-fetch when parameters change
  const { data, isLoading } = useGetSearchCourseQuery(
    ...
    {
      // This ensures the query is properly re-fetched when parameters change
      refetchOnMountOrArgChange: true,
      // Use the key in the query options
      skip: false,
    },
  )
  ...
  useEffect(() => {
    // Increment the key to force a new query
